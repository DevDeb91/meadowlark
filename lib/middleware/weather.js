const getWeatherData = () => Promise.resolve([
    {
        location: {
            name: 'Portland',
            coordinates: { lat: 45.5154586, lon: -122.6793461 },
        },
    ...
    },
    {
        location: {
            name: 'Bend',
            coordinates: { lat: 44.0581728, lon: -121.3153096 },
        },
        forecastUrl: 'https://api.weather.gov/gridpoints/PQR/30,40/forecast',
    ...
    },
    {
        location: {
            name: 'Manzanita',
            coordinates: { lat: 45.7184398, lon: -123.9351354 },
        },
